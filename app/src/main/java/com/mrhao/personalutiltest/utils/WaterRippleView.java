...
/**
 * @Title: 动态水波纹自定义view，百分比效果
 * @Description: GitHub开源项目参考：https://github.com/itrenjunhua/WaveView
 * @author: MrHao
 * @data: 2019\5\15   14:30
 */
...
public class WaterRippleView extends View {
     ...
     * @return
     */
    public WaterRippleView setWaveColor1(int waveColor1) {
     ...
     * @return
     */
    public WaterRippleView setWaveColor2(int waveColor2) {
     ...
     * @return
     */
    public WaterRippleView setBorderColor(int borderColor) {
     ...
     * @return
     */
    public WaterRippleView setTextColor(int textColor) {
     ...
     * @return
     */
    public WaterRippleView setTextSize(int textSize) {
     ...
     * @return
     */
    public WaterRippleView setWaveHeight1(int waveHeight1) {
     ...
     * @return
     */
    public WaterRippleView setWaveHeight2(int waveHeight2) {
     ...
     * @return
     */
    public WaterRippleView setWaveLenght1(int waveLenght1) {
     ...
     * @return
     */
    public WaterRippleView setWaveLenght2(int waveLenght2) {
     ...
     * @return
     */
    public WaterRippleView setBorderWidth(int borderWidth) {
     ...
     * @return
     */
    public WaterRippleView setShape(ShowShape shape) {
        this.mShape = shape;
        return this;
    }
     ...
     * @return
     */
    public WaterRippleView setOffset1(int offset1) {
     ...
     * @return
     */
    public WaterRippleView setOffset2(int offset2) {
     ...
     * @return
     */
    public WaterRippleView setTime(int time) {
        this.mTime = time;
        return this;
    }
     ...
     * @return
     */
    public WaterRippleView setPrecent(float precent) {
     ...
     * @return
     */
    public WaterRippleView setPrecentChangeListener(PrecentChangeListener precentChangeListener) {
